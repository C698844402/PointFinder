        ...
        public function render() {
            ...
            if (isset($this->value) && is_array($this->value)) {
                ...
                foreach ($slides as $slide) {
                    ...
                    echo '<li><label for="' . $this->field['id'] . '-url_' . $x . '">' . esc_html__('Slug : (Do not change or remove after beginning to use theme!)', 'pointfindercoreelements') . '</label><input type="text" id="' . $this->field['id'] . '-url_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][url]" value="' . $slide['url'] . '" class="full-text slide-url" /></li>';
