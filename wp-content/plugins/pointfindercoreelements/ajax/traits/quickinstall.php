<?php 
if (class_exists('PointfinderQuickInstall')) {
	return;
}


class PointfinderQuickInstall extends Pointfindercoreelements_AJAX
{
    public function __construct(){}


    public function pf_ajax_quicksetupprocess(){
		...
		if (in_array($myval,array(0,1,2))) {
			...
			switch ($myval) {
				...
				case "1":
					...
					update_option( 'pointfinder_predone', 1 );
					break;
				case "0":
					...
					$pointfinder_main_options_fw->ReduxFramework->set('setup3_pt14_check', 1);
					$pointfinder_main_options_sb->ReduxFramework->set('setup25_sidebargenerator_sidebars', json_decode($json_sidebar,true));
					update_option( 'pointfinder_predone', 0 );
					break;
				case "2":
					...
					$pointfinder_main_options_fw->ReduxFramework->set('setup3_pt14_check', 0);
					$pointfinder_main_options_sb->ReduxFramework->set('setup25_sidebargenerator_sidebars', json_decode($json_sidebar,true));
					update_option( 'pointfinder_predone', 2 );
					break;
			}
