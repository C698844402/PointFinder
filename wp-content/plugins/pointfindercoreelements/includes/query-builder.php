						...
						switch($thiskeyftype){
							...
							case '4':/*Text*/
								...
								switch ($target) {
									case 'search_all':
											/* Get field Settings */
											$pf_searchall_title = PFSFIssetControl('setupsearchfields_'.$pfformvar.'_searchall_title','','0');
											$pf_searchall_desc = PFSFIssetControl('setupsearchfields_'.$pfformvar.'_searchall_content','','0');
